...
object TestCaseRepeatedFields extends TestCase[TestCaseRepeatedFields] {
  ...
  override val protobuf = ProtoSerializable(
    Schemas.Repeated
      .newBuilder()
      ...
      .addUint64Field(source.ul(1))
      .addSint32Field(source.si(0))
      .addSint32Field(source.si(1))
      .addSint64Field(source.sl(0))
      .addSint64Field(source.sl(1))
      .addFixed32Field(source.fi(0))
      .addFixed32Field(source.fi(1))
      .addFixed64Field(source.fl(0))
      .addFixed64Field(source.fl(1))
      .addSfixed32Field(source.sfi(0))
      .addSfixed32Field(source.sfi(1))
      .addSfixed64Field(source.sfl(0))
      .addSfixed64Field(source.sfl(1))
      .addBoolField(source.b(0))
      .addBoolField(source.b(1))
      .addStringField(source.s(0))
      .addStringField(source.s(1))
      .addBytesField(source.by(0))
      .addBytesField(source.by(1))
      .addColorField(Color.BLACK)
      .addColorField(Color.WHITE)
      .addColorField(Color.BLACK)
      .addColorField(Color.GREEN)
      .addColorField(Color.BLACK)
      .build()
  )
}
...
case class TestCaseEmptyRepeated(d: Seq[Double], f: Seq[Float], i: Seq[Int])

object TestCaseEmptyRepeated extends TestCase[TestCaseEmptyRepeated] {
  override val source = TestCaseEmptyRepeated(Seq(1d, 2d), Seq.empty, Seq(1, 2))
